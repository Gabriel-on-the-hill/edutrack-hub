/**
 * GET /api/generator/curricula
 *
 * Proxy for Generator's GET /curricula endpoint.
 * Lists curricula available in the Generator's database.
 */
...
export default async function handler(req, res) {
  ...
  try {
    const response = await fetch(`${apiUrl}/curricula`, {
    ...
    console.error('Generator proxy error (curricula):', error);
